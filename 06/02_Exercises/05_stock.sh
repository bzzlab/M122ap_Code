#!/bin/bash
:<<'TASK'
Aufgabe: Aktien-Kurse bereinigen
Ausgangslage
...
3. Entfernen Sie jene Zeilen, welche 'Dividend' in der Zeile haben
(Tipp: siehe Artikel (https://www.systutorials.com/how-to-delete-a-specific-line-from-a-text-file-in-command-line-on-linux/)).
4. Nummerieren Sie alle Zeilen der bereinigten`stock_msft.csv` erst
am Schluss (Tipp: Help-Informationen zum `cat` lesen).
Die Ausgabe muss nicht in eine Datei geschrieben werden.
